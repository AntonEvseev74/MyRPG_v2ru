    ...
    public int столкновениеСОбъектом(Сущность сущность, boolean этоИгрок) {
        ...
        for (int i = 0; i < игроваяПанель.списокОбъектов.length; i++) {
            if (игроваяПанель.списокОбъектов[i] != null) {
                ...
                игроваяПанель.списокОбъектов[i].зонаВзаимодействия.x = игроваяПанель.списокОбъектов[i].мирХ + игроваяПанель.списокОбъектов[i].зонаВзаимодействия.x;
                игроваяПанель.списокОбъектов[i].зонаВзаимодействия.y = игроваяПанель.списокОбъектов[i].мирУ + игроваяПанель.списокОбъектов[i].зонаВзаимодействия.y;
                ...
                игроваяПанель.списокОбъектов[i].зонаВзаимодействия.x = игроваяПанель.списокОбъектов[i].зонаВзаимодействияПоУмолчаниюХ;
                игроваяПанель.списокОбъектов[i].зонаВзаимодействия.y = игроваяПанель.списокОбъектов[i].зонаВзаимодействияПоУмолчаниюУ;
            }
        }
        return индекс;
    }
